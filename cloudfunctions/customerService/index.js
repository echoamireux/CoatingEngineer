...
const REPLIES = {
  // 1. 关键词：口令/密码
  CODE: '【自动回复】\n🔑 内部访问口令：2300\n\n👉 使用方法：请在首页点击中间任意一个彩色计算卡片，在弹出的验证框中输入该口令即可解锁全功能。',
  ...
  // 5. 关键词：税务/成本
  TAX: '【自动回复】\n💰 成本核算税务逻辑：\n\n系统支持【含税】与【未税】两种模式切换：\n\n1. 材料单价：请跟随模式填写\n   • 选“含税模式”填含税价（系统会自动剥离税额）\n   • 选“未税模式”填未税价\n\n2. 机台/人工费：请始终填未税（净）成本\n   • 人工费：工资本身无增值税，企业实际支出即为净成本\n   • 机台费：行业标准核算均采用“折旧+能耗”的未税值（因电费/设备进项税通常可抵扣，不应计入成本）\n\n💡 核心逻辑：所有投入先还原为未税基础进行累加，最终输出时再统一计算总含税造价。',
